...
st.markdown('''<style>h1{color: #03a9f4;text-shadow: 1px 1.5px 2px black;font-size:300%}h2{color: #03a9f4;text-shadow: 0.4px 0.4px 1px black;}div > p > a{border: solid 1.5px;border-radius: 2px;padding: 5px;text-decoration: none;font-weight: 500;}
div > p > a:hover{background-color: #4fc3f7;color: black;text-decoration: none;}
.st-bw{font-weight: 500;font-size:150%;}
